---
title: Vol.009 Assassinating the General's Image
date: 2025-07-27
tags:
  - AI
  - Work
...
<p align="right">—— Jonathan Swift</p>
...
<p align="right">—— <i>Things to Make and Do in the Fourth Dimension</i>, Matt Parker</p>
...
<p align="right">—— Dongdong Qiang</p>
...
<p align="right">—— <i>What Smart People Think Before They Speak</i>, Hiroshi Anda</p>
...
The novel *The Elementary Particles* argues that "From the moment people ceased to believe in immortality, there was no longer any such thing as religion."
By that logic, technology has already taken on a religious flavor, as many people now harbor a tangible fantasy of digital immortality.

***

For my generation, a major mindset behind choosing graduate school was waiting for the pandemic to pass and the job market to improve.
So, rather than pursuing higher education, it felt more like delaying graduation.
...
Since my job requires frequent sending and receiving of English emails, I wrote a set of prompts based on internal documentation. Later, I stumbled upon a [version written by Li Jigang](https://x.com/lijigang_com/status/1946809224727838947?t=Qp_NScUr2AJR2kB7UzrzBA&s=19), which was noticeably more elegant. So, I used AI to "fuse" them into the following version:
...
Consequently, I used Gemini CLI to write two simple Python scripts: one to [rename files based on creation time](https://github.com/fengyukongzhou/FileTimeRename), and another to [convert the format of exported notes from my Boox Neoreader](https://github.com/fengyukongzhou/Boox-Note-Converter). They are incredibly simple little tools, built purely to solve tiny inconveniences in my daily digital organization.
