---
title: Vol.017 New Year in a Trance
date: 2026-02-13
tags:
  - Design
  - AI
...
<p align="right">— Rabindranath Tagore, <i>Gitanjali</i></p>
...
<p align="right">— Byung-Chul Han, <i>The Burnout Society</i></p>
...
<p align="right">— Max Bennett, <i>A Brief History of Intelligence</i></p>
...
<p align="right">— Tang Nuo, <i>Seeking the Sword</i></p>
...
<p align="right">— Valeria Luiselli, <i>Lost Children Archive</i></p>
...
To my surprise, I started using Gemini CLI as early as last July, which was also when I connected it to my Obsidian vault (Vol.009 Assassinating the Image of the General). Usually, I pair it with the [Terminal](https://github.com/polyipseity/obsidian-terminal) plugin—this plugin isn't crucial, but it saves me a step by opening the command line directly in the current directory.

The new version of Gemini CLI finally supports Skills.

A Skill essentially "atomizes" various commands and includes a "summary" at the beginning of the prompt file. Compared to the previous `GEMINI.md` prompts, the Agent can now independently choose workflows based on the task, scanning first and reading closely later—a mechanism known as "[progressive disclosure](https://mp.weixin.qq.com/s/jUylk813LYbKw0sLiIttTQ)".
...
Since we are using Agent tools to control Obsidian, there are some ready-made Skills we can use directly, such as [obsidian-skills](https://github.com/kepano/obsidian-skills) and [axton-obsidian-visual-skills](https://github.com/axtonliu/axton-obsidian-visual-skills). The latter is a collection of visualization-related Skills that can render Excalidraw, Canvas, and Mermaid.
...
Just now, struck by inspiration, I wrote an automated execution version using Google AI Studio—[CoverGen AI](https://ai.studio/apps/drive/1QUaP_JHLB863vKDXUsjZ9ldXX26LNZOI). Let's connect with a frontline worker to explain the specific implementation process:
